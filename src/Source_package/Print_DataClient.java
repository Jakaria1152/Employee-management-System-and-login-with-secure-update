...
public class Print_DataClient implements ActionListener{
	JFrame f;
    ...
    String emp_id, name, father, address, phone, email, education, post, age,dob,nid;
    JButton b1,b2;
    ImageIcon icon;
	
    Print_DataClient(String e_id)
	{
		try
		{
			Conn conn = new Conn();
